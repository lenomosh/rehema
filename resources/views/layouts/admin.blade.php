...
<head>
    ...
    <title>RSPES| Lennox Omondi</title>
    {{--Data tables--}}
    ...
    <!--Ajax Loader  -->
    <link rel="stylesheet" href="{{asset('ajax.bjax.min.css')}}">
    <!-- Morris chart -->
...
<!-- <script src="{{asset('ajax/bjax.min.js')}}"></script> -->
<!-- <script>
$('a').bjax();
</script> -->
...
<body  class="hold-transition skin-black-light sidebar-mini">
  <!-- <div id="loader"></div> -->
<div class="pace page-loading  pace-active">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li><a href="{{route('register')}}"><i class="fa fa-circle-o text-red"></i>
                        <span>Add New User</span></a></li>
...
window.addEventListener("beforeunload",function(e){
    ...
    function getquotes() {
        let quotemessage = document.getElementById('getQuotes');
        const spinner = document.getElementById('spinner').hidden = false;
        let authorname = document.getElementById('quoteAuthor');
        let JsonCall = new XMLHttpRequest();
        JsonCall.open("GET", "{{route('quotes')}}", true);
        JsonCall.onprogress = function () {
            document.getElementById('spinner').hidden = false;
        };
        JsonCall.ontimeout = function () {
            document.getElementById('error-message').hidden = false;
        };
        JsonCall.onerror = function () {
            document.getElementById('error-message').hidden = false;
        };
        JsonCall.onload = function () {
            ...
            if (this.status === 200) {
                ...
                res = res.data;
                let ran = res.length;
                ran = Math.floor(Math.random() * Math.floor(ran));
                quotemessage.innerHTML = res[ran].quote;
                authorname.innerHTML = res[ran].author;
                document.getElementById('spinner').hidden = true;
            }
        };
        JsonCall.send();
